...
interface Props {
  onChange: (p: { q?: string; tag?: string }) => void;
}
...
export default function SearchPanel({ onChange }: Props) {
  ...
  return (
    /*
      ⚠️ NO sticky aquí: el contenedor externo (<div className="lg:sticky…" />)
      ya maneja la posición. Tener dos sticky anidados provocaba que el panel
      "rebotara" y se superpusiera con Huella en la comunidad.
    */
    <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50 w-full lg:w-72 space-y-4">
